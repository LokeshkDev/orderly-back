...
const ReturnsPolicy = () => {
  ...
  const pageTitle = cmsPolicy.title || settings?.returns_policy_title || 'Returns & Exchange Policy';
  const pageSubtitle = cmsPolicy.subtitle || 'Seamless Delivery & Doorstep Exchanges';
  ...
  return (
    <>
      <SEO 
        ...
        description="Read ORDERLY's easy 15-day returns, refund policy, and garment exchange guidelines."
